...
sudo scutil --set ComputerName "bajra"
sudo scutil --set HostName "bajra"
sudo scutil --set LocalHostName "bajra"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "bajra"
...
defaults write NSGlobalDomain AppleLanguages -array "ne" "en" "sv"
defaults write NSGlobalDomain AppleLocale -string "ne_SE"
